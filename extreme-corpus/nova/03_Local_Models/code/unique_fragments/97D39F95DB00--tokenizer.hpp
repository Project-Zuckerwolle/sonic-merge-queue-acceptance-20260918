...
//
// SPEC Abschnitt 6. Drei Algorithmenfamilien (BPE byte-level und
...
//
// Abnahme (SPEC Abschnitt 6): die Referenz-Token-IDs aus `tests/data/tokenizers/`
...
// Die oeffentliche API aus SPEC Abschnitt 7 braucht `tokenize` und
// `detokenize`, keine Zeichenbereiche. Das spart die gesamte
// Alignment-Buchhaltung. Begruendet im Bericht zu Stufe 3.
...
class Tokenizer {
 public:
  ...
  // wandert in den Tokenizer-Abschnitt des Quasar Blocks (SPEC Abschnitt 4.2:
