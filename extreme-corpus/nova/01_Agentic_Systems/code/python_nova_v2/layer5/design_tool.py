"""Nova Predator v1 Layer 5 — Design-Tool.

Generiert vollständige UI-Code-Dateien für den Agent.
Wird als design_ui Tool vom ClawTools-Dispatcher aufgerufen.
"""
from __future__ import annotations

from core.logger import get

log = get("layer5.design_tool")
...
def gen_tkinter(beschreibung: str, stil: str, komponenten: list[str]) -> str:
    ...
    return (
        '#!/usr/bin/env python3\n'
        f'"""\n{beschreibung}\nGeneriert von Nova Predator v1 Agent — design_ui\n"""\n'
