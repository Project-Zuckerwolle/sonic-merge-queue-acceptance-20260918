    ...
    def run_python(self, code: str, timeout: int = 30) -> dict[str, Any]:
        ...
        try:
            proc = subprocess.run(
                ...
                timeout=timeout, cwd=str(self.root, creationflags=_NO_WINDOW),
            )
            return {
    ...
    def install_package(self, package_name: str) -> dict[str, Any]:
        ...
        try:
            proc = subprocess.run(
                ...
                capture_output=True, encoding="utf-8", text=True, timeout=120, creationflags=_NO_WINDOW)
            return {
