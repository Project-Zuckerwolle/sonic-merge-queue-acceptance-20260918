...
class MarcosEngine;  // MARCOS-MDP-Overlay (marcos_mdp.h), optional/flag-gated.
...
public:
    ...
    // MARCOS-MDP-Overlay (§6): steuert Reward/Confidence/Backtracking. nullptr = klassischer Loop.
    void set_marcos(MarcosEngine* m) { marcos_ = m; }
